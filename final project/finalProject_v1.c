...
void turnAround(void);
		...
		volatile unsigned char recordedState[1750] = { 0 };
		volatile unsigned int stateTime[1750] = { 0 };
		volatile unsigned int stateIndex = 0;
...
// ******************************************************************************************* //
        ...
        //CHANGE THESE PARAMETERS TO CHANGE THE MOTOR OPERATION
                ...
                PR2 = 0x0200;   //0x03FF;             //Number of cycles is 1023      
